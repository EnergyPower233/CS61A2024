...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls:
        ...
        if current_dice_value == 1:
            isSowSad = True
        # else:
        res += current_dice_value
        num_rolls -= 1
    return 1 if isSowSad else res

    # res = 0
    # while num_rolls:
    #     current_dice_value = dice()
    #     if current_dice_value == 1:
    #         return 1 # 这里不对 因为他要扔够骰子
    #     else:
    #         res += current_dice_value
    #         num_rolls -= 1
    # return res
...
def take_turn(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    #Wrong Anwser
    # return max(roll_dice(num_rolls), boar_brawl(player_score, opponent_score=))
...
def play(strategy0, strategy1, update,
    ...
    of dice to roll, current player's score, the opponent's score, and the
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    return max(range(1, 11), key = lambda i: make_averaged(roll_dice, samples_count)(i, dice))
    # END PROBLEM 9
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    return 0 if sus_points(boar_brawl(score, opponent_score)+ score) >= score + threshold else num_rolls  # Remove this line once implemented.
    # END PROBLEM 11
