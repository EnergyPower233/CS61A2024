    ...
    def nearest_bee(self):
        ...
        def check(place, distance):
            ...
            if distance < self.lower_bound:
                return check(place.entrance, distance + 1)
            if place.bees:
                return random_bee(place.bees)
            else:
                return check(place.entrance, distance + 1)
        return check(self.place, 0)
        # END Problem 3 and 4
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        for x in pla.bees[:]:
            x.reduce_health(amount if self.health > 0 else amount + self.damage) 
        # END Problem 5
    ...
    def insects_in_front(self):
        ...
        def check(place,distance):
            if place.is_hive:
                ...
                check(place.entrance, distance + 1)
        check(self.place, 0)
        res.pop(self)
        return res
        # END Problem Optional 2
