...
class VendingMachine:
    ...
    def vend(self):
        ...
        #     tempfund = self.funds
        #     self.funds = 0
        #     return f'Here is your {self.name} and ${tempfund} change.'
        # else:
        #     self.funds = 0
        #     self.amount -= 1
        #     return f'Here is your {self.name}.'
        else:
            tempfundB = self.funds
            self.funds -= self.price
            self.amount -= 1
            tempfundA = self.funds
            self.funds = 0
            return f'Here is your {self.name}.' if  tempfundB == self.price else f'Here is your {self.name} and ${tempfundA} change.'
